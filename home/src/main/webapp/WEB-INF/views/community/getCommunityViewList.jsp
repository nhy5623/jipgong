  ...
  <section class="hero">
    ...
    $(document).ready(function () {
        ...
        $(".heart").on("click", function () {
            ...
            $.ajax({url :"/community/getCommunityViewList/heart",                
                type :'POST',
                data : sendData,
		...
		<div id="reply">
						...
						<c:if test="${member.user_id == null }">
							<!--로그인 이랑 연동  -->
							<p>
								덧글을 남기시려면 <a href="/login/login">로그인 </a>해주세요
							</p>
						</c:if>
							...
							<section class="replyForm">
								<form role="form" method="post" autocomplete="off">
									...
									<div class="input_area">
										<textarea name="repCon" id="repCon" style="width: 790px;"></textarea>
									</div>
								...
								<script>
									$("#reply_btn").click(function() {
										...
										$.ajax({url : "/community/getCommunityViewList/registReply",
											type : "post",
											data : data,
											success : function() {
												replyList();
...
<script>
 $(document).on("click", ".delete", function(){
  ...
  $.ajax({
   url : "/community/getCommunityViewList/deleteReply",
   type : "post",
   data : data,
   ...
   error : function(){
 	   alert("로그인하셔야합니다.")
					...
					<!--수정, 삭제  -->
					<c:if test="${CommunityViewList.community_id == member.user_id }">
										<!--수정, 삭제  -->
					<a href="/community/communityModify?community_bno=${CommunityViewList.community_bno }">
...
<div class="replyModal">
 <div class="modalContent">
    <div>
   <textarea class="modal_repCon" name="modal_repCon" style="width:475px; height:150px;"></textarea>
  </div>
    <div>
...
<script>
	$(document).ready(function() {
		...
		$("button[data-oper='modify']").on("click", function(e) {
			operForm.attr("action", "/community/communityModify")
		...
		$("#delete_Btn").click(function() {
			operForm.attr("action", "/community/communityDelete");
			operForm.submit();
		});
...
<script>
	$("#reply_btn").click(function() {
		...
		$.ajax({
			url : "/community/getCommunityViewList",
			type : "post",
			data : data,
			success : function() {
				replyList();
...
$(".modal_modify_btn").click(function(){
 ...
 if(modifyConfirm) {
  ...
  $.ajax({
   url : "/community/getCommunityViewList/modifyReply",
   type : "post",
   data : data,
   success : function(result){
