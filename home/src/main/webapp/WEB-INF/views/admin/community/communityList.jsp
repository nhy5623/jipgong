...
<div class="container">
<a href="/admin/community/registerCommunity">글작성</a>
<h3>오늘의 추천 게시물 </h3>
	...
	<div class="grid">
		<!-- <div class="row"> -->
			<div class="col-md-4">
				...
				<a href="/admin/community/getCommunityViewList?community_bno=${communityList.community_bno }">
					<img src="${communityList.gdsImg}" class="oriImg" />	
						<figcaption>
						<h2>${communityList.community_thema}</h2>
						조회수 <span>${communityList.community_viewcount}</span><br>
						좋아요 <span>${communityList.community_good}</span>
...
actionForm.attr("action","/community/communityList/get");
actionForm.submit();
});
</script>
