...
<%--  <%=request.getRealPath("/") %> --%>
 			...
 			<div class="inputArea">
					<label for="link1" style="width:100px;">링크 추가</label>
					<input type="text" id="link1" name="link1" />
			</div>
			
			<div class="inputArea">
 				<label for="link2"style="width:100px;">링크 추가</label>
 					<input type="text" id="link2" name="link2" />
			</div>
			
			<div class="inputArea">
 				<label for="link3"style="width:100px;">링크 추가</label>
 					<input type="text" id="link3" name="link3" />
			</div>
			
			<div class="inputArea">
 				<label for="link4"style="width:100px;">링크 추가</label>
 					<input type="text" id="link4" name="link4" />
			</div>
			
			<div class="inputArea">
 				<label for="link5"style="width:100px;">링크 추가</label>
