...
<body>
	<div>
		<div class="col-lg-12">
		<button class="btn btn-primary" onclick = "location.href = '/store/kitchen'">식탁</button>
		<button class="btn btn-primary" onclick = "location.href = '/store/desk'">책상</button>
	...
	<br>
	<form id="actionForm" action="/store/table" method="get">
